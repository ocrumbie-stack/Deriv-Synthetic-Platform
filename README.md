...
- `DERIV_ACCOUNT_ID`: required in live mode. Set this to the TradingView account login ID, including a seven-digit numeric ID if that is what Deriv shows, so balance reads and all trades target that account.
